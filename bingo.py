...
model = joblib.load(r'G:\Mi unidad\1 Archivos py\4 GEEK\2 PROYECTOS\29 FINAL INMO\02 EDA + RF MADRID\MODEL3.sav')
...
st.set_page_config(
    page_title="Predicción de Precio de Propiedades",
    page_icon="🏠",
    layout="wide",
...
st.title('Predicción de Precio de Propiedades en Madrid')
...
st.sidebar.text('Desarrollado por: Tu Nombre')
st.sidebar.text('Fecha: Septiembre 2023')
>>>>>>> 11b32bd85fb0f76a6943bd8b382c195e0988127d
